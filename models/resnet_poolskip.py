...
class BottleNeck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = nn.Sequential(
            ...
            # different with original here
            pool_skip(out_channels, out_channels, kernel_size=3, stride=1, padding=1, pool_size=4),
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True),
            ...
            # different with original here
            pool_skip(out_channels*BottleNeck.expansion, out_channels*BottleNeck.expansion, 
                      kernel_size=3, stride=1, padding=1, size=4),
